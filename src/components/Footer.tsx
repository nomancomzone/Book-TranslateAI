        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://wa.me/8801700000000" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-green-600 rounded-full flex items-center justify-center hover:bg-green-700 transition-colors" title="WhatsApp">
              ...
              <a href="https://m.me/translatedbook" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#1877F2] rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors" title="Messenger">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.36 2 2 6.13 2 11.7c0 2.91 1.2 5.42 3.15 7.18V22l3.04-1.67c.82.23 1.68.35 2.58.35h.23c5.64 0 10-4.13 10-9.68S17.64 2 12 2zm1.08 13.03l-2.55-2.73L5.4 15.26l5.64-5.99 2.62 2.73 5.06-2.96-5.64 5.99z"/></svg>
              </a>
            </div>
            <p className="text-xs text-gray-500 mt-4 bengali-text">সকাল ১০টা - রাত ১০টা</p>
          </div>
        </div>
